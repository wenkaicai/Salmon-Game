...
Entity createOctopus(RenderSystem* renderer, vec2 position)
{
	// Reserve en entity
	auto entity = Entity(2);
	...
	registry.renderRequests.insert(
		entity,
		{ TEXTURE_ASSET_ID::OCTOPUS,
			EFFECT_ASSET_ID::TEXTURED,
			GEOMETRY_BUFFER_ID::SPRITE });

	return entity;
}
Entity createAsteroidea(RenderSystem* renderer, vec2 position)
{
	// Reserve en entity
